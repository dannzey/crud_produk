...
void updateDataProduk(fstream &data)
{
    Produk updateProduk;
    int nomor;
    cout << "masukan no. produk yang ingin dirubah: ";
    cin >> nomor;
    cin.ignore(numeric_limits<streamsize>::max(),'\n');

    cout << "Data yang akan dirubah : " << endl;
    updateProduk = readData(data, nomor);
    cout << "nama:" << updateProduk.nama << endl;
    cout << "harga:" << updateProduk.harga << endl;

    cout << "Proses perubahan data produk : " << endl;
    cout << "nama produk : ";
...
void checkDatabase(fstream &data)
{
    ...
    if(data.is_open()) {
        ...
        cout << "database belum ada, tolong bikin baru" << endl;
        data.close();
